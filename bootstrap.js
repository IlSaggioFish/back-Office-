(async()=>{
  ...
  try{
    for(const href of ['./v7.css?v=7','./v8.css?v=8','./v9.css?v=9','./v10.css?v=10.2','./mobile.css?v=10.3','./v11.css?v=11','./v12.css?v=12','./v12.1.css?v=12.1','./v15.css?v=15']){const l=document.createElement('link');l.rel='stylesheet';l.href=href;document.head.appendChild(l);}
    let faces=null;
    ...
    for(const src of [
      ...
      './v7.js?v=7','./v8.js?v=8','./v8fix.js?v=8','./v9.js?v=9','./v9fix.js?v=9','./v10.js?v=10','./v10replay.js?v=10.2','./mobile.js?v=10.3','./v11maps.js?v=11','./v11mengasi.js?v=11.1','./v11clarity.js?v=11.2','./v12graphics.js?v=12','./v12.1.js?v=12.1','./v13characters.js?v=13','./v14characters.js?v=14','./v15graphics.js?v=15'
    ])await load(src);
