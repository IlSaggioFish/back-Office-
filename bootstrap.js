(async()=>{
  ...
  try{
    for(const href of ['./v7.css?v=7','./v8.css?v=8','./v9.css?v=9','./v10.css?v=10.2']){const l=document.createElement('link');l.rel='stylesheet';l.href=href;document.head.appendChild(l);}
    let faces=null;
    ...
    for(const src of [
      ...
      './v7.js?v=7','./v8.js?v=8','./v8fix.js?v=8','./v9.js?v=9','./v9fix.js?v=9','./v10.js?v=10','./v10replay.js?v=10.2'
    ])await load(src);
