...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/bootstrap.js')){
    e.respondWith(caches.match('./bootstrap.js?v=12').then(r=>r||fetch('./bootstrap.js?v=12',{cache:'no-store'})));
    return;
  }
