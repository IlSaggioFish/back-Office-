...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/bootstrap.js')){
    e.respondWith(caches.match('./bootstrap.js?v=11.1').then(r=>r||fetch('./bootstrap.js?v=11.1',{cache:'no-store'})));
    return;
  }
