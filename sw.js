...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/bootstrap.js')){
    e.respondWith(caches.match('./bootstrap.js?v=14').then(r=>r||fetch('./bootstrap.js?v=14',{cache:'no-store'})));
    return;
  }
